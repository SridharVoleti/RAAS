...
import { LayoutDashboard, BookOpen, CreditCard, Users, Mail, Shield, BarChart2, LogOut, Type, Newspaper, Settings, Heart, ClipboardList, MessageSquareQuote, GraduationCap, Compass, Award } from 'lucide-react'
